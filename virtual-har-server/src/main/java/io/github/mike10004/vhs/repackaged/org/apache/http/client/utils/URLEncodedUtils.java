...
public class URLEncodedUtils {
    ...
    public static List<Map.Entry<String, String>> parse(
        ...
        requireNonNull(buf, "Char array buffer");
    ...
    public static List<NameValuePair> parseToNameValuePairs(String query, Charset charset) {
        return parse(query, charset).stream()
                .map(entry -> NameValuePair.of(entry.getKey(), entry.getValue()))
...
//        return format(parameters, QP_SEP_A, Charset.forName(charset));
//    }
